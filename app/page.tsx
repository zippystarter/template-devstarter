  ...
  <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary selection:text-primary-foreground overflow-x-hidden">
   ...
   >
    ...
    <div className="absolute inset-0 z-0">
     ...
     {/*/>*/}
     {/*<div className="diagonal-lines-container w-full h-full object-cover opacity-40">*/}
     {/* <div className="diagonal-line line-left"></div>*/}
     {/* <div className="diagonal-line line-main-back"></div>*/}
     {/* <div className="diagonal-line line-main-front"></div>*/}
     {/* <div className="diagonal-line line-right"></div>*/}
     {/*</div>*/}
     <div className="diagonal-lines-container-2">
    ...
    <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
     <div className="space-y-6">
      ...
      <p className="text-xl text-muted-foreground max-w-md leading-relaxed">
       ...
       Specialized in scalable distributed systems and interactive 3D
       interfaces.
      </p>
     ...
     <div className="grid md:grid-cols-12 gap-12">
      <div className="md:col-span-4">
       ...
       <p className="text-muted-foreground mb-8">
        My preferred weapons of choice for building digital products. Always
     ...
     <div className="space-y-8 max-w-4xl mx-auto">
      {blogPosts.map((post, index) => (
       <div key={index} className="group cursor-pointer">
        ...
        <p className="text-muted-foreground mb-4 max-w-2xl">{post.excerpt}</p>
    ...
    <div className="container mx-auto max-w-2xl">
     <div className="text-center mb-12">
      ...
      <p className="text-muted-foreground">
       Have a project in mind or just want to discuss the singularity? Send a
       signal.
      </p>
     </div>

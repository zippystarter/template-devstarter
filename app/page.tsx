...
export default function Home() {
  ...
  const skills = [
    { category: "Frontend", items: ["React", "TypeScript", "Tailwind CSS", "Three.js", "Next.js"] },
    { category: "Backend", items: ["Node.js", "Go", "PostgreSQL", "Redis", "Docker"] },
    { category: "Tools", items: ["Git", "Linux", "AWS", "Kubernetes", "Figma"] }
  ];
      ...
      <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary selection:text-primary-foreground overflow-x-hidden">
        ...
        <Container component="header" wrapperClassName="fixed top-0 left-0 w-full z-50 bg-background/80 backdrop-blur-md border-b border-border" className="mx-auto max-w-7xl flex items-center justify-between h-16 uppercase">
            ...
            <nav className="hidden md:flex gap-8 text-sm font-medium text-muted-foreground ">
              ...
              <a href="#blog" className="hover:text-primary transition-colors">Logs</a>
          ...
          <div className="container mx-auto relative z-10 grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <h1 className="text-6xl md:text-8xl font-bold tracking-tighter leading-[0.9]">
                FULL<br/>
                STACK<br/>
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-white">DEV_</span>
              </h1>
              <p className="text-xl text-muted-foreground max-w-md leading-relaxed">
                Architecting digital voids and crafting high-performance web experiences.
                Specialized in scalable distributed systems and interactive 3D interfaces.
              </p>
              <div className="flex gap-4 pt-4">
                <Button size="lg" className="bg-primary text-primary-foreground hover:bg-primary/90 font-bold rounded-none">
            ...
            <div className="hidden md:block relative h-[500px] w-full border border-border/30 bg-card/10 backdrop-blur-sm p-8">
              ...
              <div className="h-full w-full flex flex-col justify-between font-mono text-xs text-muted-foreground">
                ...
                <div className="text-right">
                  <span className="block text-4xl font-bold text-foreground">03</span>
          ...
          <div className="container mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-4">
              ...
              <p className="text-muted-foreground max-w-sm text-right md:text-left">
                A collection of experiments, production apps, and open source contributions.
              </p>
            </div>

            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {projects.map((project, index) => (
                  <Card key={index} className="pt-0 group bg-card border-border hover:border-primary/50 transition-all duration-300 rounded-none overflow-hidden">
                    ...
                    <CardHeader>
                      ...
                      <div className="flex flex-wrap gap-2 mt-2">
                        {project.tags.map(tag => (
                            <Badge key={tag} variant="secondary" className="rounded-none font-mono text-xs bg-secondary/50 text-secondary-foreground border-transparent">
                              {tag}
                            </Badge>
                        ))}
                      </div>
                    ...
                    <CardFooter className="flex justify-between pt-0">
                      <a href={project.link} className="text-sm font-bold flex items-center hover:text-primary transition-colors">
                        LIVE DEMO <ExternalLink className="ml-2 h-3 w-3" />
                      </a>
                      <a href={project.repo} className="text-sm font-bold flex items-center hover:text-primary transition-colors">
        ...
        {/* Skills Matrix */}
        <section id="skills" className="py-24 bg-secondary/20 border-t border-border">
          <div className="container mx-auto">
            <div className="grid md:grid-cols-12 gap-12">
              <div className="md:col-span-4">
                <h2 className="text-4xl font-bold tracking-tighter mb-6">TECH_STACK</h2>
        ...
        <section id="blog" className="py-24 border-t border-border">
          <div className="container mx-auto">
            <h2 className="text-4xl font-bold tracking-tighter mb-12 text-center">TRANSMISSIONS</h2>
        ...
        <section id="contact" className="py-24 bg-card border-t border-border">
          <div className="container mx-auto max-w-2xl">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold tracking-tighter mb-4">INITIATE_CONTACT</h2>
            ...
            <form className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input id="name" placeholder="John Doe" className="rounded-none bg-background border-border focus:border-primary" />
                </div>
                <div className="space-y-2">
                  <label htmlFor="email" className="text-xs font-mono text-muted-foreground">EMAIL</label>
                  <Input id="email" type="email" placeholder="john@example.com" className="rounded-none bg-background border-border focus:border-primary" />
                </div>
              </div>
              <div className="space-y-2">
                <label htmlFor="message" className="text-xs font-mono text-muted-foreground">MESSAGE</label>
                <Textarea id="message" placeholder="Enter your message..." className="min-h-[150px] rounded-none bg-background border-border focus:border-primary" />
              </div>
              <Button type="submit" className="w-full rounded-none bg-primary text-primary-foreground hover:bg-primary/90 font-bold py-6">
                SEND TRANSMISSION
              </Button>
            </form>
          </div>
